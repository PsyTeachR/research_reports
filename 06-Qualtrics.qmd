...
# Creating Questionnaires and Behavioural Tasks {#06-Qualtrics}

In this chapter, we outline common tools and software you will have access to or will hear about, then explain some key principles in creating questionnaires, behavioural tasks, and considerations for collecting data in-person compared to online. Before your dissertation, you might not have the opportunity to design your own study yet, but it is important you know how to create your own questionnaires and tasks using common tools and software. This is also critical for employability as it's helpful to know how to create and design surveys across many job roles.  
...
- Building Experiments in PsychoPy (2nd edition) by @peirce2022building explains how to create behavioural tasks using PsychoPy. 

- Similarly, Python for Experimental Psychologists (2nd edition) by @Dalmaier_2024 demonstrates how to code experiments and analyses using Python and PsychoPy. 

- This video by Xiaojin Ma is quite long, but it walks through [Using PsychoPy to build a cognitive psychology experiment from scratch](https://youtu.be/CMJXEEA7Rvc?si=ykhTqeCJPogiAvuQ){target="_blank"}.
